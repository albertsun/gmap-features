...
(function(){function a(a){a=$(a);return $.map(a.find("Placemark"),function(a){var b={};$placemark=$(a);b.geom=$placemark.find("MultiGeometry")[0];b.id=$placemark.find("name").text();b.fields={};for(var a=$placemark.find("ExtendedData Data"),g,d,e=0,h=a.length;e<h;e++)g=$(a[e]),d=g.find("value").text(),isNaN(parseFloat(d))||(d=Number(d)),b.fields[g.attr("name")]=d;return b})}gmap.load_polygons=function(b){var f={},c=b.data,g={selected:null};b.data_type==="kml"&&(c=a(c));b.unselected_opts&&gmap._.extend(gmap.Feature.prototype._unselected_poly_options,
b.unselected_opts);b.highlighted_opts&&gmap._.extend(gmap.Feature.prototype._highlighted_poly_options,b.highlighted_opts);b.selected_opts&&gmap._.extend(gmap.Feature.prototype._selected_poly_options,b.selected_opts);for(var d,e=0,h=c.length;e<h;e++){d=c[e].geom.coordinates?c[e].geom.type=="Polygon"?[gmap.geom.ParseGeoJSONPolygon(c[e].geom.coordinates)]:gmap.geom.ParseGeoJSONMultiPolygon(c[e].geom.coordinates):gmap.geom.ParseKMLMultiPolygon(c[e].geom);d={id:c[e].id,multipolygon:d,fields:c[e].fields,
controller:g,map:b.map};if(b.getColor)d.color=b.getColor(c[e].fields);if(b.highlightCallback)d.highlightCallback=b.highlightCallback;if(b.selectCallback)d.selectCallback=b.selectCallback;f[c[e].id]=new gmap.Feature(d)}return f}})();
