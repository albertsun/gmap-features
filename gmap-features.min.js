...
(function(){gmap._=window._||function(){var a={},b={},g=Array.prototype.slice,c=Array.prototype.forEach,e=a.each=a.forEach=function(a,f,g){if(null!=a)if(c&&a.forEach===c)a.forEach(f,g);else if(a.length===+a.length)for(var e=0,j=a.length;e<j&&!(e in a&&f.call(g,a[e],e,a)===b);e++);else for(e in a)if(hasOwnProperty.call(a,e)&&f.call(g,a[e],e,a)===b)break};a.extend=function(a){e(g.call(arguments,1),function(b){for(var c in b)void 0!==b[c]&&(a[c]=b[c])});return a};return a}();google.maps.LatLng.prototype.toGeoJSON=
function(){return[this.lng(),this.lat()]};google.maps.MVCArray.prototype.toGeoJSON=function(){for(var a=this.getArray(),b=[],g=0,c=a.length;g<c;g++)b.push(a[g].toGeoJSON());return b};gmap.Feature=function(a){function b(){e.setHighlighted(!0)}function g(){e.setHighlighted(!1)}function c(){e.getSelected()?e.setSelected(!1):e.setSelected(!0)}var e=this;this.id=a.id;this.polygons=[];a.fields&&(this.fields=a.fields);this.controller=a.controller;this._highlighted=this._selected=!1;this.highlightCallback=
...
(function(){function a(a){a=$(a);return $.map(a.find("Placemark"),function(a){var b={};$placemark=$(a);b.geometry=$placemark.find("MultiGeometry")[0];b.id=$placemark.find("name").text();b.properties={};for(var a=$placemark.find("ExtendedData Data"),e,d,f=0,h=a.length;f<h;f++)e=$(a[f]),d=e.find("value").text(),isNaN(parseFloat(d))||(d=Number(d)),b.properties[e.attr("name")]=d;return b})}gmap.load_polygons=function(b){var g={},c=b.data,e={selected:null},c="kml"==b.data_type?a(c):c.features;b.unselected_opts&&
gmap._.extend(gmap.Feature.prototype._unselected_poly_options,b.unselected_opts);b.highlighted_opts&&gmap._.extend(gmap.Feature.prototype._highlighted_poly_options,b.highlighted_opts);b.selected_opts&&gmap._.extend(gmap.Feature.prototype._selected_poly_options,b.selected_opts);for(var d,f=0,h=c.length;f<h;f++)d="array"!==typeOf(c[f].geometry.coordinates)?gmap.geom.ParseKMLMultiPolygon(c[f].geometry):"Polygon"==c[f].geometry.type?[gmap.geom.ParseGeoJSONPolygon(c[f].geometry.coordinates)]:gmap.geom.ParseGeoJSONMultiPolygon(c[f].geometry.coordinates),
d={id:c[f].id,multipolygon:d,fields:c[f].properties,controller:e,map:b.map},b.getColor&&(d.color=b.getColor(c[f].properties)),d.responsive_unselected_opts=b.responsive_unselected_opts,d.responsive_highlighted_opts=b.responsive_highlighted_opts,d.responsive_selected_opts=b.responsive_selected_opts,d.highlightCallback=b.highlightCallback,d.selectCallback=b.selectCallback,g[c[f].id]=new gmap.Feature(d);return g};gmap.remove_polygons=function(a){for(var g in a)a.hasOwnProperty(g)&&(a[g].remove(),delete a[g]);
return a}})();
