...
getSelected:function(){return this._selected},setSelected:function(a){if(a===true)this.controller.selected!==null&&this.controller.selected.setSelected(false),this._selected=true,this.controller.selected=this,this.redraw(),this.selectCallback&&this.selectCallback();else if(a===false)this._selected=false,this.redraw()},getHighlighted:function(){return this._highlighted},setHighlighted:function(a){if(a===true&&this._highlighted===false)this._highlighted=true,this.redraw(),this.highlightCallback&&this.highlightCallback();
else if(a===false&&this._highlighted===true)this._highlighted=false,this.redraw()}}})();if(!window.typeOf)window.typeOf=function(a){var b=typeof a;b==="object"&&(a?a instanceof Array&&(b="array"):b="null");return b};if(!window.console)window.console={log:function(){}};gmap=gmap||{};gmap.geom=gmap.geom||{};
...
d={id:c[f].id,multipolygon:d,fields:c[f].properties,controller:e,map:b.map};if(b.getColor)d.color=b.getColor(c[f].properties);d.responsive_unselected_opts=b.responsive_unselected_opts;d.responsive_highlighted_opts=b.responsive_highlighted_opts;d.responsive_selected_opts=b.responsive_selected_opts;d.highlightCallback=b.highlightCallback;d.selectCallback=b.selectCallback;g[c[f].id]=new gmap.Feature(d)}return g}})();
